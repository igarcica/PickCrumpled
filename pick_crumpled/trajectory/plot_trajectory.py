        ...
        while self._running:
            ...
            try:
                ...
                with self._lock:
                    ...
                    self.x_vals.append(base.tool_pose_x)
                    self.y_vals.append(base.tool_pose_y)
                    self.z_vals.append(base.tool_pose_z)
                    self.rx_vals.append(base.tool_pose_theta_x)
                    self.ry_vals.append(base.tool_pose_theta_y)
                    self.rz_vals.append(base.tool_pose_theta_z)
...
def main():
    ...
    # Start recording
    sampler = PoseSampler(cyclic_client)
    sampler.start()
